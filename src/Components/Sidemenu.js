...
// import SessionStorageService from "../../front-end/sessionstorage.service";
// import fas
...
const sidemenu = ({ open, setOpen, onMenuClick }) => {
        ...
        <div>
            <div className={`${open ? "w-72" : "w-20"} hidden lg:block duration-300 p-3 h-screen relative`}>
                <div className={`logo mx-auto text-center bg-[#ffffff12] rounded-3xl ${!open ? "px-1 py-1 min-h-fit" : "px-0"}`}>
                    <img className={`${!open ? "w-full" : "max-w-[100px] w-full mx-auto"} ${!open && "rotate-[360deg]"} duration-500 cursor-pointer hover:rotate-[360deg] hover:scale-110`} src="./images/logo.png" alt="logo" />
                ...
                <ul className={`${open ? "px-4" : "px-1"} sidemenuC `}>
                    ...
                    {/* <li  className={open ? "text-white text-sm font-medium flex items-center border-2 border-transparent rounded-md gap-x-4 cursor-pointer mt-3 p-2 duration-150 hover:bg-[#F6FFEF] hover:border-[#ABD28E] hover:text-[#588A7A] justify-center hover:scale-105 hover:shadow-[0px_2px_3px_#5b8c7d]":""}>
                        <span className="text-2xl block float-left sideIcon">
                             <MdOutlineSpaceDashboard /> 
                        </span>
                        <Link to="/" className={`text-base font-medium flex-1 ${!open && "hidden"}`}>Dashbord</Link>
                    </li>
                    <li  className="text-white text-sm font-medium flex items-center border-2 border-transparent rounded-md gap-x-4 cursor-pointer mt-3 p-2 duration-150 hover:bg-[#F6FFEF] hover:border-[#ABD28E] hover:text-[#588A7A] justify-center hover:scale-105 hover:shadow-[0px_2px_3px_#5b8c7d]">
                        <span className="text-2xl block float-left sideIcon">
                             <FaUserCog /> 
                        </span>
                        <Link to="/Menu" className={`text-base font-medium flex-1 ${!open && "hidden"}`}>Menu</Link>
                    </li> */}
                    <ul className={`${open ? "px-2" : "px-0"} mb-3 `}>
                        <li className={`todayspl text-white text-sm font-medium flex items-center bg-[#6fa27a5e] w-100 rounded-md gap-x-4 cursor-pointer mt-3 p-0 duration-150 justify-center hover:scale-110 hover:shadow-[-1px_3px_11px_#3c6256] border-2  ${open ? "border-[#74C870]" : "border-transparent"}`}>
                            ...
                            <span className="text-2xl block float-right">
                                <img className="max-w-[45px]" src="/images/offer.png" alt="offer" />
                            </span>
                        </li>
                    </ul>
                </ul>
