      ...
      <div className="m-auto h-100">
        <div className="Mywidth bg-[#F4F8E2] border-[#D1D1D1] border-[1.5px]">
          <div className="mybg h-100">
            <div className="Profilestyle">Setting</div>
            <Row className="marginsettings">
              <Col md={8} className="px-2" style={{ cursor: "pointer" }}>
                <div className="settingcard">
                  <Row>
                    <Col md={6}>
                      <div className="iconcard  d-flex justify-content-center"><IoSettingsSharp className="h-100 w-75" /></div>
                    </Col>
                    <Col md={18} className="px-2">
                      <div className="Generalfont">General Setting</div>
                      <div className="Viewfontsetting">View and update your store detials</div>
                    </Col>
                  </Row>
                </div>
              </Col>
