            ...
            <div className="m-auto">
                <div className="contentPartreast bg-[#F4F8E2] border-[#D1D1D1] border-[1.5px] cardredieos">
                    <div className="btnflex">
                        <button className={active ? "Restaurantbtnunactive py-2 px-4" : " Restaurantbtn px-4 py-2"} onClick={handleClickbtn1}>Restaurant Information</button>
                        <button className={active ? " Restaurantbtn px-4 py-2" : "Restaurantbtnunactive py-2 px-4"} onClick={handleClickbtn}>Restaurant Owner Information</button>
                    </div>
                    {information && <div>
                        <Restaurant />
                    </div>}
